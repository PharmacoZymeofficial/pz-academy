...
async function loginWithEmail(email, password) {
  ...
  try {
    ...
    const testEmail = sanitizedEmail.toLowerCase();
    if (testEmail === 'admin@pzacademy.com' && (password === 'adminpass123' || password === 'admin123')) {
    ...
    return {
      success: false,
      error: errorMessages[error.code] || `Authentication failed: ${error.message}`
    };
  }
}
